      ...
      <main className={styles.bodyPolitique}>
        <div className={styles.contenuPolitique}>
          ...
          <p className={styles.contenuPolitique}>
            La Compagnie AnimaGo! a décidé d'offrir les meilleurs services de
            site Web d'Animal en restant connecté à leurs utilisateurs à tout
            moment de la journée et en créant une expérience unifiée entre leurs
            technologies et leurs utilisateurs à un tout autre niveau.
          </p>
          <p className={styles.contenuPolitique}>
            ...
            réflexions et les commentaires d'un utilisateur deviennent un livre,
            mais si vous connectez tout cela avec de nombreux utilisateurs, cela
            devient un AnimaGo!
          </p>
          ...
          <p className={styles.contenuPolitique}>
            ...
            façon sécuritaire qui lui permettra plus tard voir l'historique des
            sélections qui ont été faites mais aussi de bénéficier des
          ...
          <p className={styles.contenuPolitique}>
            C'est un blogue qui permet à l'administrateur de partager des
            nouvelles en lien au site ou aux produits, ainsi qu'aux personnes de
            partager leurs opinions et recommandations sur les produits et de
            discuter à propos des animaux.
          </p>
